  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5.bg_img_1
    ...
    .bloque-texto-t.justify-content-center.align-items-center.mb-0
      .bloque-texto-t__img.mb-0
        img(src='@/assets/curso/temas/tema1/img_1.png', alt='Código de programación en pantalla, representación de software')
      .bloque-texto-t__texto.col-10.mb-0
        p.mb-0 La familia de normas ISO/IEC 25000, conocida como <em>SQuaRE</em> (System and Software Quality Requirements and Evaluation), constituye un marco integral para evaluar la calidad de productos de software. Dicho conjunto normativo se orienta a establecer criterios, medir atributos y proporcionar lineamientos para asegurar que el desarrollo y mantenimiento de software responda a las expectativas del cliente y se ajuste a las necesidades de uso, independientemente del contexto en el que se aplique. Este modelo se fundamenta en las normas anteriores (ISO/IEC 9126 y ISO/IEC 14598) y responde a la evolución de las tecnologías y metodologías de desarrollo.
