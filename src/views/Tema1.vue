  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5.bg_img_1
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 1
      h1 Introducción a la norma ISO/IEC 25000 <em>SQuaRE</em>
    .bloque-texto-t.justify-content-center.align-items-center.mb-0
      .bloque-texto-t__img.mb-0
        img(src='@/assets/curso/temas/tema1/img_1.png', alt='Código de programación en pantalla, representación de <em>software</em>')
      .bloque-texto-t__texto.col-10.mb-0
        p.mb-0 La familia de normas ISO/IEC 25000, conocida como <em>SQuaRE</em> (<em>System and software Quality Requirements and Evaluation</em>), constituye un marco integral para evaluar la calidad de productos de <em>software</em>. Dicho conjunto normativo se orienta a establecer criterios, medir atributos y proporcionar lineamientos para asegurar que el desarrollo y mantenimiento de <em>software</em> responda a las expectativas del cliente y se ajuste a las necesidades de uso, independientemente del contexto en el que se aplique. Este modelo se fundamenta en las normas anteriores (ISO/IEC 9126 y ISO/IEC 14598) y responde a la evolución de las tecnologías y metodologías de desarrollo.
    ...
    .row.justify-content-center.align-items-center.mb-0
      ...
      .col-12.col-lg-7.mb-0.order-3.order-lg-3.p-0
        .custom-slider.p-5.p-sm-3
          SlyderF(columnas="col-12 col-sm-10 col-md-6 col-lg-6").p-2.rounded-3
            .tarjeta.p-2.rounded-3.d-flex
              .custom-slider__tarjeta.custom-slider__tarjeta--1
                .custom-slider__title.color-secundario-20.mb-3.mb-md-3.mb-lg-5 2501n – Modelo de calidad 
                .custom-slider__content Define las características y subcaracterísticas que debe poseer el producto de  <I>software</i> para cumplir con estándares de calidad, estableciendo parámetros que abarcan desde la funcionalidad hasta la usabilidad y seguridad.
            .tarjeta.p-2.rounded-3.d-flex
              .custom-slider__tarjeta.custom-slider__tarjeta--2
                .custom-slider__title.color-secundario-20.mb-3.mb-lg-5  2502n – Medidas de calidad 
                .custom-slider__content Proporciona un marco para la definición y aplicación de métricas que permiten cuantificar la calidad en diferentes contextos, incluyendo medidas internas, externas y en uso.
            .tarjeta.p-2.rounded-3.d-flex
              .custom-slider__tarjeta.custom-slider__tarjeta--3
                .custom-slider__title.color-secundario-20.mb-3.mb-lg-5 2503n – Requisitos de calidad 
                .custom-slider__content Especifica los requisitos que debe satisfacer el producto, sirviendo como base para la planificación y desarrollo, y garantizando que se cumplan las expectativas del cliente.
            .tarjeta.p-2.rounded-3.d-flex
