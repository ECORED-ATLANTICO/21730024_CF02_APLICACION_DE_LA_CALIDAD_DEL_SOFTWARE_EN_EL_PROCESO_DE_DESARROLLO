...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    .row.justify-content-center.align-items-center.mb-0
      .col-lg-11.mb-3
        .titulo-sexto.color-institucional
          h2 Aplicación de la calidad del software en el proceso de desarrollo
          p Síntesis: Fundamentos y procesos en calidad de software
      .col-lg-1.mb-3
        figure
